...
class wizard_product_small_label_report(models.TransientModel):
    ...
    def action_preview(self):
        ...
        pdf_data = self.env['report'].get_html(self, 'dynamic_product_small_label.prod_small_lbl_rpt', data=datas)
    ...
    def action_print(self):
        ...
        return self.env['report'].get_action(self,
                        'dynamic_product_small_label.prod_small_lbl_rpt', data=datas)
